...
<template>
  <section id="home" class="pt-36 dark:bg-dark md:pt-10">
    <div class="container">
      <div
        class="mx-auto flex flex-col items-center justify-center px-6 py-8 md:h-screen lg:py-0"
      >
        <div
          class="w-full rounded-lg border bg-white shadow-lg dark:border-gray-700 dark:bg-gray-800 sm:max-w-md md:mt-0 xl:p-0"
        >
